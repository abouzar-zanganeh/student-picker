...
سیستم مدیریت یکپارچه دسته‌بندی‌ها: اکنون می‌توانید دسته‌بندی‌ها را برای دو منظور متفاوت تعریف کنید: یکی برای مشارکت در کلاس (مانند "گرامر" و "لغت") و دیگری به عنوان فعالیت قابل نمره‌دهی (مانند "امتحان میان‌ترم" یا "پروژه"). این کار با یک چک‌باکس ساده در هنگام ساخت دسته‌بندی انجام می‌شود.
...
سیستم نمره‌دهی کاملاً پویا و قابل شخصی‌سازی: سیستم نمره‌دهی دیگر به ۴ مهارت ثابت محدود نیست. اکنون، هر دسته‌بندی که توسط معلم به عنوان "قابل نمره‌دهی" علامت‌گذاری شود، به صورت خودکار به عنوان یک دکمه نمره‌دهی در پروفایل دانش‌آموز ظاهر می‌شود. این به معلم اجازه می‌دهد تا برای فعالیت‌های کاملاً شخصی‌سازی شده مانند "کوئیز"، "پروژه کلاسی" یا "میانگین تکلیف" نمره ثبت کند.

ایجاد پیش‌فرض‌های هوشمند: هنگام ساخت یک کلاس جدید، سیستم به طور خودکار چهار دسته‌بندی قابل نمره‌دهی پیش‌فرض (Listening, Speaking, Reading, Writing) را ایجاد می‌کند تا شروع به کار سریع و آسان باشد.
...
تاریخچه کامل نمرات و یادداشت‌ها: تمام نمرات و یادداشت‌های ثبت‌شده برای یک دانش‌آموز به همراه تاریخ و توضیحات در پروفایل او به صورت مرتب نمایش داده می‌شود.
