...
### ۱۸. قابلیت نصب (PWA) و استفاده آفلاین
...
-   **عملکرد آفلاین**: به لطف استفاده از **Service Worker**، تمام فایل‌های اصلی برنامه (مانند HTML, CSS, JavaScript) در حافظه دستگاه شما ذخیره (Cache) می‌شوند. این به شما امکان می‌دهد تا حتی در صورت عدم دسترسی به اینترنت، برنامه را باز کرده و از آن استفاده کنید.
...
-   Progressive Web App (PWA) technologies (`manifest.json`, `Service Worker`) for installability and offline support
