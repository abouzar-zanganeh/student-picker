// @ts-nocheck
/* ==========================================================================
   models.js introduction
   --------------------------------------------------------------------------
   This JS file defines core data models (Student, Classroom, Session, 
   Category) and their specific business logic.
   ========================================================================== */
...
export class Homework {
    constructor(status = 'notChecked', comment = '') {
